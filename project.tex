...
We wish to calculate the maximum sustained wind speed from 24 to 60 hours after first measurement. Our predictors are as follows:
\begin{enumerate}
    \item The maximum sustained wind speed from 0 to 24 hours after first measurement.
    \item The minimum Sea Level Pressure
    \item Maximum potential intensity 
    \item The basin which the storm develops in
\end{enumerate}

We assume that the basin which the storm develops in will control the parameters governing the model.
